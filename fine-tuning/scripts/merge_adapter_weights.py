...
class ScriptArguments:
    peft_model_id: Optional[str] = field(
        default="philschmid/instruct-igel-001", metadata={"help": "the model name"})
    output_dir: Optional[str] = field(
        default="merged-weights", metadata={"help": "where the merged model should be saved"})
    save_tokenizer: Optional[bool] = field(
        default=True, metadata={"help": "whether to save the tokenizer"})
